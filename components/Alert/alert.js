...
export var Alert = function (props) {
    ...
    var customCloseItem = customClose || React.createElement(Icon, { icon: "times", className: "window-close", size: 'lg' });
    ...
    return (React.createElement(Transition, { in: visible, timeout: 300, animation: "zoom-in-left", wrapper: true },
        React.createElement("div", { className: classes },
            ...
            closable ? React.createElement("i", { onClick: handleClick }, customCloseItem) : null)));
};
Alert.defaultProps = {
    closable: true,
    type: 'primary'
