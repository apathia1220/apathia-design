...
export var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: "apathia-upload-list" }, fileList.map(function (item) {
        return (React.createElement("li", { className: "apathia-upload-list-item", key: item.uid },
